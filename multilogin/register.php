...
if (isset($_POST['register'])) {
	...
	if (empty($fname)) {
		...
		$error['error'] = "sname is empty";
	}else if(empty($specialite)){
		$error['error'] = "specialite is empty";
	...
	if (count($error) < 1) {
		...
		$query = "INSERT INTO users(firstname,surname,specialite,gender,role,password) VALUES('$fname','$sname','$specialite','$gender','$role','$pass')";
			...
			<div class="row d-flex justify-content-center">
				<div class="col-md-6 shadow-sm" style="margin-top:100px;">
					<form method="post">
						...
						<input type="text" name="sname" class="form-control my-2" placeholder="Enter Username" autocomplete="off">

						<label>specialite</label>
						<input type="text" name="specialite" class="form-control my-2" placeholder="Enter specialite" autocomplete="off">
