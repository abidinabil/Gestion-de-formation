            ...
            <div class="course-item">
              ...
              <div class="course-content">
                <div class="d-flex justify-content-between align-items-center mb-3">
                  <h4><?php echo "Theme de Formation: " .$row['theme'];   ?></h4>
                  
                  
                </div>
                 
                <h3><?php echo "Mode de Formation: " .$row['mode'];   ?></h3>
                <h3><?php echo "Lieu de Formation: " .$row['lieu'];   ?></h3>
                <h3><?php echo "Periode de Formation: " .$row['periode'];   ?></h3>
                <br><a href="read.php?read=<?php echo $row['id_c']; ?>" class='btn btn-primary'>read more</a>
